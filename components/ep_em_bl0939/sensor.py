...
BL0939Component = bl0939_ns.class_("BL0939", cg.PollingComponent, uart.UARTDevice)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(BL0939Component),
...
FINAL_VALIDATE_SCHEMA = uart.final_validate_device_schema(
    "bl0939", baud_rate=4800, require_rx=True, require_tx=True
)
