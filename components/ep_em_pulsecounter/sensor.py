...
empc_ns = cg.esphome_ns.namespace("empc")
EmPcComponent = empc_ns.class_("EmPcComponent", cg.PollingComponent)
EmPcInitialMode = empc_ns.enum("EmPcInitialMode")
EmPcSensorModels = empc_ns.enum("EmPcSensorModels")

INITIAL_MODES = {
    CONF_CURRENT: EmPcInitialMode.EMPC_INITIAL_MODE_CURRENT,
    CONF_VOLTAGE: EmPcInitialMode.EMPC_INITIAL_MODE_VOLTAGE,
}

MODELS = {
    "HLW8012": EmPcSensorModels.EMPC_SENSOR_MODEL_HLW8012,
    "CSE7759": EmPcSensorModels.EMPC_SENSOR_MODEL_CSE7759,
    "BL0937": EmPcSensorModels.EMPC_SENSOR_MODEL_BL0937,
}
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(EmPcComponent),
